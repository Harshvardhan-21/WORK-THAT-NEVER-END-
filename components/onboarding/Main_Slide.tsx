...
import { ws, hs, rf, safeTop } from '../../utils/responsive';
import { SRV_LOGO_URI } from '../../utils/logoBase64';
import { counterboyURI, customerURI, dealerURI, electricianURI } from '../../utils/roleImages';
          ...
          <View style={s.rolesRow}>
            {ROLES.slice(0, 2).map((r) => (
              <RoleCard
                ...
                border={r.border}
                image={r.image}
                cover={r.key === 'user' || r.key === 'counter-boy'}
